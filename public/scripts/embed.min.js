(function(){const url=window.location.hostname==="localhost"?"http://localhost:3000":"https://ponsor.vercel.app";const payload=document.querySelector("script[data-widget-id]");const{widgetId,placement}=payload.dataset;if(!widgetId)return;const attr=payload.getAttribute.bind(payload);const searchParams=attr("data-widget-id");const constructIframe=src=>{let iframe=document.createElement("iframe");iframe.width="100%";iframe.height="100%";iframe.src=src;return iframe};const style=document.createElement("style");style.innerHTML=`.embed, .embed-btn {
